...
public interface IXPath {
    ...
    static ELEMENTS
            ...
            individualSearch =  ELEMENTS.INDIVIDUAL_SEARCH_CATEGORY_PEOPLE,
            chatHeader =        ELEMENTS.CHAT_HEADER,
            callingStartButton = ELEMENTS.CALLING_START_BUTTON,
            div =               ELEMENTS.DIV,
            a =                 ELEMENTS.A,
            p =                 ELEMENTS.P,
            span =              ELEMENTS.SPAN,
    ...
    static ATTRIBUTES
            ...
            any_att =           ATTRIBUTES.ANY,
            withVideo =         ATTRIBUTES.WITH_VIDEO,
...
//    Table<ACTIONS, LinkedList<ATTRIBUTES>, LinkedList<XPathValues>>                                                         newXPathTable = HashBasedTable.create();
    ...
    static String getXPath_DivEqualsDataTid(String dataTidValue) {
        return new XPath(doubleSlash, div, equals, dataTid, dataTidValue).getXPath();
    }
